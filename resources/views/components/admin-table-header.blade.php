<div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
  ...
  <div class="w-full md:w-1/2">
    <form class="flex items-center gap-4" action="{{ $action }}">
      @csrf
      {{-- filter --}}
      <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
        class="w-14 md:w-28 flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
        type="button">
      ...
      <div class="flex gap-4">
        <div class="w-full">
          <input type="text" id="search" name="search" 
            ...
            placeholder="Search by name / title" value="{{ request('search') }}">
        </div>
        <button type="submit" class="relative flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm pl-4 pr-7 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
