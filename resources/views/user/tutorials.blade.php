...
<x-main-page-layout>
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class=" max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-20">
      <div class="mr-auto place-self-center">
        {{-- header --}}
        <h1 class="max-w-2xl mb-8 text-4xl font-semibold leading-none dark:text-white">
          Tutorials
        </h1>
        ...
        <div class="w-fit mb-8 relative">
          <input type="text" id="search" name="search"
            ...
            placeholder="Search...">
          {{-- <button type="submit"
            class="absolute top-0 right-0 flex items-center justify-center bg-transparent focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-2 focus:outline-none dark:focus:ring-primary-800">
            <svg aria-hidden="true" class="w-5 h-5 text-gray-900 dark:text-white" fill="currentColor" viewbox="0 0 20 20"
        ...
        <div class="w-full grid grid-cols-2 lg:grid-cols-3 gap-x-2 gap-y-6">
          ...
          @foreach ($groups as $group)
            <div>
              <h3 class="text-xl font-semibold mb-2 text-gray-900 dark:text-white">{{ $group->name }}</h3>
              <ul>
                @foreach ($group->courses as $course)
                    <li>
                      @php
                        $firstArticleId = $course->articles->first()->id ?? 0;
                      @endphp
                      <a href="/courses/{{ $course->slug }}/{{ $firstArticleId }}" 
      ...
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
          <a href="/" class="flex items-center">
            ...
            <span class="ml-2 self-center text-xl font-semibold whitespace-nowrap dark:text-white">Learn2Code</span>
          </a>
        </div>
